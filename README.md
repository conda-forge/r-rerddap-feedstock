...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=4842&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/r-rerddap-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `r-rerddap` can be installed with `conda`:
...
```
mamba install r-rerddap
```

It is possible to list all of the versions of `r-rerddap` available on your platform with `conda`:
...
```
mamba search r-rerddap --channel conda-forge
```
...
mamba repoquery search r-rerddap --channel conda-forge

# List packages depending on `r-rerddap`:
mamba repoquery whoneeds r-rerddap --channel conda-forge

# List dependencies of `r-rerddap`:
mamba repoquery depends r-rerddap --channel conda-forge
```
